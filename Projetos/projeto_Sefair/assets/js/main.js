...
/* ===================
   SCRIPT ATUALIZADO PARA CARDS DO MAPA
   (Interativo com Marcadores e Lista)
==================== */
document.addEventListener('DOMContentLoaded', () => {

    // Seleciona TODOS os elementos clicáveis (marcadores E itens da lista)
    ...
    // 1. Adiciona o evento de clique em CADA ELEMENTO (marcador ou item da lista)
    ...
    document.addEventListener('click', (e) => {
        // Checa se o clique foi fora de um card E fora de um elemento clicável
        if (!e.target.closest('.mapa-card') && !e.target.closest('[data-target]')) {
            hideAllCards();
        }
    });
